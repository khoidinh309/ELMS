...
public class LeaveDayAPIDbContext :
    AbpDbContext<LeaveDayAPIDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<LeaveRequest>(lr =>
        {
            lr.ToTable("LeaveRequests");
            lr.Property(x => x.Title)
                .HasMaxLength(LeaveRequestConsts.MaxTitleLength)
                .IsRequired();
            lr.Property(x => x.Reason)
                .IsRequired();
            lr.Property(x => x.StartDate) .IsRequired();
